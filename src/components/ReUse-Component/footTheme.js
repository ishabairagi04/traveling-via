const destinationThemes = {
  ...
  rajasthan: {
    icon: "🏜️",
    background: "linear-gradient(to right, #fff3e0, #ffe0b2, #ffcc80)",
    text: "#4B2E2E",
    subText: "#7B4A1A",
    accent: "#FFC107",
    hover: "#FFB300",
    border: "#FFD54F",
    inputBg: "rgba(255, 238, 179, 0.7)",
    waveGradient: [
  ...
  hyderabad: {
    icon: "🏙️",
    background: "linear-gradient(to right, #ffe6e6, #ffd6cc, #ffb3b3)",
    text: "#5C1A1B",
    subText: "#7B3A3A",
    accent: "#FF6B6B",
    hover: "#FF4C4C",
    border: "#FFABAB",
    inputBg: "rgba(255, 204, 204, 0.7)",
    waveGradient: [
      { offset: "0%", color: "#ffe6e6" },
      { offset: "50%", color: "#ffd6cc" },
      { offset: "100%", color: "#ffb3b3" },
    ],
  },
    ahemdabad: {
    icon: "🕌",
    background: "linear-gradient(to right, #fdf6e3, #fceabb, #f8d49d)",
    text: "#4A2C2A",
    subText: "#7B5E57",
    accent: "#d97706",
    hover: "#b45309",
    ...
    waveGradient: [
      ...
      { offset: "50%", color: "#fceabb" },
      { offset: "100%", color: "#f8d49d" },
    ],
  },
